...
\begin{figure}[ht]
	\centering
	\includegraphics[angle=270,width=0.8\textwidth]{comparason_graph.pdf}
...
% list....
% 	first point aint at start, arbitary units.
% 	trending towards zero filesize at 100% removed
%	curves on top of each other not equal
%	curves due to image complexity
