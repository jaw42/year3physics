\section{Spitzer Space Telescope} % (fold)
\label{sec:spitzer_space_telescope}
    ...
    \subsection{Studies involving Spitzer} % (fold)
    \label{sub:studies_involving_spitzer}
        ...
        \end{table}
    % subsection studies_involving_spitzer (end)
% section spitzer_space_telescope (end)
