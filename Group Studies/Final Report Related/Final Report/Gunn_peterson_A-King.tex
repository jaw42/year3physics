...
\label{sec:the_gunn_peterson_effect}
	...
	\label{sub:the_lyman_break}
		...
		\end{align}		% Bajtlik, S., Duncan, R.C., & Ostriker, J.P. 1988 % radiatin is scattered not absorbed
		...
		\end{figure}% talk about resulting lyman alpha forest, especially at low redshifts
	...
	\subsection{Derivation of the Gunn-Peterson Optical Depth} % (fold)
	\label{sub:derivation_of_the_gunn_peterson_optical_depth}
		...
		\begin{align}
			\tau_{GP} = 3.59 \times 10^5 \left ( \frac{\Omega_m h^2}{0.13}\right )^{-1/2}
					...
					\left ( \frac{n_{HI}}{n_H}	\right ) .
		\end{align}
	% subsection derivation_of_the_gunn_peterson_optical_depth (end)
% section the_gunn_peterson_effect (end)
