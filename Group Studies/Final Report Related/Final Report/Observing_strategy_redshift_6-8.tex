...
\section{Observing Strategy for Redshift 6--8} % (fold)
\label{sec:observing_strategy_for_redshift_6_8}
	...
	\subsection{Results for E-ELT} % (fold)
  ...
  %       	\begin{minipage}[c]{0.8\linewidth}
		...
		% 			\begingroup\endlinechar=-1
		% 				\resizebox{\textwidth}{!}{%
		% 					\input{GRAPH_Mag_vs_galaxies_JWST_ELT_10.tex}
		% 				}\endgroup
	...
	\subsection{Detailed Results for JWST} % (fold)
...
32 		& \num{3.8e5} 	& 128.461 	& N/A 					& N/A 					& $128.46\pm$ (1)
	...
	\subsection{Total Time for Survey} % (fold)
