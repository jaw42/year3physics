...
\subsection{Using Euclid for a Survey of edshift 8.54 to 10.1} % (fold)
\label{sub:using_euclid_for_a_survey_of_edshift_8_54_to_10_1}
	...
	\begin{figure}[!htbp]
		...
		\caption{Number of galaxies expected for different magnitudes, given set overall observing time for the Euclid Telescope.\label{fig:galaxies_expected_JWST_6-8}}
	\end{figure}
