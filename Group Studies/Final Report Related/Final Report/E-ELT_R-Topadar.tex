...
\subsection{The European Extremely Large Telescope} % (fold)
\label{sub:the_european_extremely_large_telescope}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.8\textwidth]{E-ELT.png}
		\caption{An artist’s impression of the E-ELT\cite{E_ELT_Enclosure}}\label{fig:figure1}
	\end{figure}
	...
	The E-ELT utilises a three mirror anastigmat system with two further mirrors providing the adaptive optics, shown below in figure -, with the fifth mirror directing the beam towards the Nasmyth focus\cite[p.~16]{E_ELT_Construction_Proposal}. The primary mirror, measuring \SI{39.3}{\metre} in diameter, will be comprised of 798 hexagonal segments eventually producing a collecting area of \SI{978}{\square\metre}. The E-ELT will therefore have a light collecting power approximately 13 times larger than any existing telescope and is predicted to produce images 16 times sharper than those of the Hubble Space Telescope. Other new generation extremely large telescopes include the Giant Magellan Telescope with a primary mirror of diameter \SI{25}{\metre} and the Thirty Meter Telescope with a primary mirror of diameter \SI{30}{\metre}. The E-ELT however remains the largest of these planned telescopes.
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.9\textwidth]{Anastigmat.png}
...
% subsection the_european_extremely_large_telescope (end)
