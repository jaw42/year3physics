	...
	\label{sub:charged_coupled_devices}
		...
		\label{ssub:sky_background}
			...
			\begin{figure}[htbp]
				...
				\caption[Zodiacal light vs angle]{The relationship between intensity of zodiacal light and the angle to the plane of the solar sytem}\label{fig:zodiacal_light_graph}
			\end{figure}
