...
\subsection{Determingin Redshift} % (fold)
	...
	\subsubsection{Filters and the Dropout Technique} % (fold)
		...
		% subsubsection filters_and_the_dropout_technique (end)

% subsection determingin_redshift (end)
