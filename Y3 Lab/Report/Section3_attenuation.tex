...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{BF3data2.pdf}
  \caption{If the two points are removed, the straight line fit is much more accurate. These seemingly erroneous data points can be explain by considering the distance over which a thermal neutron is slowed down sufficiently for the detector to be able to observe it. \label{fig:bf3errorest}}
\end{figure}
